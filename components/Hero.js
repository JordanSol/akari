...
const Hero = () => {
    return (
        ...
        <section id='home' className='w-screen h-screen overflow-y-hidden relative flex justify-center items-center'>
            <Background speed={1}>
                <img src='/bg.png' alt='background layer 1' className='h-screen object-cover'/>
            </Background>
            <Background speed={30}>
                <img src='/layer2.png' alt='background layer 2' className='h-screen w-full object-cover'/>
            </Background>
            <Background speed={60}>
                <img src='/layer3.png' alt='background layer 3' className='hidden md:flex w-full z-40 h-screen object-cover object-center'/>
                <img src='/layer3mobile.png' alt='background layer 3' className='flex md:hidden w-full z-40 h-screen object-cover object-right'/>
            ...
            <Background speed={70}>
                ...
                <div className='absolute bottom-0 right-12  w-2 text-white flex-col justify-center'>
                    ...
                    <img src="/Arrow 1.svg" alt='arrow vector' className='margin-0'/>
                </div>
            </Background>
            <Background speed={70}>
