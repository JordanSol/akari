...
const Hero = () => {
    return (
        ...
        <section id='home' className='w-screen h-screen overflow-y-hidden relative flex justify-center items-center'>
            <Background speed={1}>
                <Image priority quality='100' layout='fill' src='/bg.png' alt='background layer 1' className='h-screen object-cover'/>
            </Background>
            <Background speed={30}>
                <Image priority quality='100' layout='fill' src='/layer2.png' alt='background layer 2' className='h-screen w-full object-cover'/>
            </Background>
            <Background speed={60}>
                ...
                <div className='relative w-screen h-screen flex justify-center items-center'>
                    <div className=''>
                        ...
                        <div className='w-40 sm:w-48 md:w-72 lg:w-96 mt-2 relative'>
                            <Image priority quality='100' layout='fill' src="/Vector.svg" alt="Akari NFT" />
                        </div>
                    </div>
                </div>
            </Background>
